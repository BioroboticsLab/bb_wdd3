...
class WaggleDetectionLoss_New(nn.Module):
    ...
    def forward(self, predictions, targets):
        ...
        if obj_mask.sum() > 0:
            ...
            # L2 loss on normalized direction vectors
            # This avoids the zero gradient problem of cosine similarity
            # while still measuring angular distance effectively
            dir_loss = F.mse_loss(pred_dir_obj, target_dir_obj)
