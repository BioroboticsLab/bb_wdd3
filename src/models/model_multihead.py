...
class R2Plus1D_YOLO_MultiHead(nn.Module):
    ...
    def __init__(
        ...
        # Shared feature projection (256 -> 128)
        ...
        # Shared feature processing - INCREASED from 64->64 to 128->128
        self.shared_features = self._depthwise_block(128, 128, dropout_rate)
        
        # Spatial confidence head - INCREASED capacity
        ...
        # Direction head - INCREASED capacity
        ...
        # Temporal head - INCREASED capacity
